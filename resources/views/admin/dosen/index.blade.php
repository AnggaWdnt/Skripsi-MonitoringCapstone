                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="py-3.5 px-4 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <!-- Delete Button -->
                                        <button onclick="openDeleteModal('{{ route('admin.dosen.delete', $dosen->id) }}', 'Apakah Anda yakin ingin menghapus dosen ini? Data profil dosen akan dihapus dan hubungan bimbingan mahasiswa dengan dosen yang bersangkutan akan terputus.')"
